...
const EditProduct = () => {
    ...
    useEffect(()=>{
        ...
        getProductById();
        // ketika ada perubahan pada id maka kita akan memanggil use effect ini
    }, [id]);
    ...
    const updateProduct = async (e) => {
        ...
        // redirect jika berhasil menambahkan data
        navigate("/");
    }
    ...
    <div className='max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300'>
        <form onSubmit={updateProduct} className='my-10'>
            <div className="flex flex-col">
                ...
                <button type='submit' className='w-full py-3 font-blod text-white bg-indigo-600
